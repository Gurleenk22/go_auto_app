...
# Title
st.title("🚗 Vehicle Popularity Analysis App")
...
if option == "Used Cars":
    ...
    st.subheader("🔍 Brand-Level Clusters (Used Cars)")
    ...
    st.subheader("📊 Vehicle-Level Clusters (Used Cars)")
    ...
    st.subheader("🔍 Brand-Level Clusters (New Cars)")
